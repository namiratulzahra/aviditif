        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <form action="../mail/submitvisual.php" method="POST">
                    ...
                    <textarea id="example"">[
    {"title":"Inspired","subtitle":"","ranges":[1,3,5],"measures":[3,3],"markers":[1]},
    {"title":"Alert","subtitle":"","ranges":[1,3,5],"measures":[1,1],"markers":[3]},
    {"title":"Excited","subtitle":"","ranges":[1,3,5],"measures":[5,3],"markers":[4]},
    {"title":"Enthusiastic","subtitle":"","ranges":[1,3,5],"measures":[4,4],"markers":[1]},
    {"title":"Determined","subtitle":"","ranges":[1,3,5],"measures":[3,4],"markers":[2]}
]</textarea>
                ...
                <div class="container">
                    ...
                    <p class="item-intro">Masukkan data pada text area dibawah ini. Atau gunakan contoh data pada <a href="https://raw.githubusercontent.com/davidchang/MoodMeme/master/public/test/bullets.json"> halaman ini</a>.</p>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" readOnly="true" class="form-control" style="height: 47px;" placeholder="Bullet Chart">
                                            <input type="hidden" readOnly="true" class="form-control" id="vizid" name="vizid" style="height: 47px;" value="5">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
